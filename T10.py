...
ki.login(qr=True)
#ki.login(token="Eni9sF6Ns15fgAXSGV87.7aNdCEtbMUaAO9Hiv0qoTW.ZIA01S8p0+qqLPs4i/Zu0/AppknZwHFR4JTn25xOT9k=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(qr=True)
#kk.login(token="EnceHaf6Iy4MCqraHlxc.SJRuNecAXNC8sHurfor2ha.KZqwwycOz6ezjEONNvFMa4V/Z31GMPj5pHQxe9YVVr0=")
kk.loginResult()
...
ks.login(qr=True)
#ks.login(token="EnWNC28GvfH2C6GY6T32.ZNOnP4uou95euS+Ku1ce4G.ot5wRrwav0m3VQOplLE7O03pnxSPL0wA5GRMR01LueI=")
ks.loginResult()

k1 = LINETCR.LINE() #nami
k1.login(qr=True)
#k1.login(token="En6kfz5AKvYPM6D07Kq2.buJLD7JrrngDnMf5qDfqyG.WxVqrUeh3QjyTpZuTtt4oBxyabwKtloSn53nrINFEPs=")
k1.loginResult()

k2 = LINETCR.LINE() #nico robin
k2.login(qr=True)
#k2.login(token="EnAen8qjmnxfJ47gXUI9.nuUU5kRRG+fC3Z9YVNv7Qq.msFPFd+RjsPInw6cAtkR/HaCGuWqIzUhzoaVp3TqMqI=")
k2.loginResult()

k3 = LINETCR.LINE() #
k3.login(qr=True)
#k3.login(token="EnF1odLGaFsKX8lyk2af.9eQsWmyR4F9AFNPZDyQTtW.zgHBwchCi5UIV8JjRCJYvJL2LHfHWK+98lrdiwrGfsg=")
k3.loginResult()

k4 = LINETCR.LINE() #
k4.login(qr=True)
#k4.login(token="EncJsNRxGBTUxOFDgd52.WUI0jVzzeewupQ5tboz8mG.metVRhFTEjnad8Z3Dx4rYbke/hvupL0xRrke0/uRAnk=")
k4.loginResult()

k5 = LINETCR.LINE() #
k5.login(qr=True)
#k5.login(token="Enc22i8pdDytcXPY8OG3.TrVjFf5pyd8D+ZxPusvq0W.XY2Pp3M2jv22RkIK+jb7iDcFtjN5I8J38j4XA7omCC4=")
k5.loginResult()

satpam = LINETCR.LINE() # 
#satpam.login(token="Enc22i8pdDytcXPY8OG3.TrVjFf5pyd8D+ZxPusvq0W.XY2Pp3M2jv22RkIK+jb7iDcFtjN5I8J38j4XA7omCC4=") 
#satpam 
...
Creator=["u350cc7408cc6cc82e056ee046131f925","ub51bc97c5e4f603f1dff35e9512550d3"]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"тerima Kasih Sudah Menambahkan Aku",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ By😊/boy29putra",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
