...
helpMessage ="""
====={List Keyword]=====
► Help>>[Melihat Daftar perintah Bot]
► Creator[Melihat Si Pembuat Bot]
► Gcreator[Melihat Si Pembuat Gruop]
► List group:[Melihat Daftar Gruop kita]
► Leave group:[Fungsi Keluar group
► Cancel[fungsi Membatalkan undang gruop]
► Url:on/off [fungsi Untuk Mengambil link kode Qr]
► Autojoin:on/off [fungsi untuk Otomatis Join Undangan]
► Autocancel:on/off [fungsi otomatis membatalkan Undangan member]
► Qr:on/off [Fungsi buka/tutup kode Qr
► Autokick:on/off [fungsi otomatis kick member]
► Contact:on/off [Fungsi buka / tutup Kontak 
► Gift (1,2,3) [memberi Hadiah]
► Tagall [Fungsi Mention Semua Member di group
► Setview [Fungsi Untuk Cctv]
► Viewseen [fungsi Menampilkan daftar pelaku Cctv]
► Boom [Fungsi Kick dengan Tag Nama]
► Add all [Fungsi otomatis menambahkan Teman]
► Recover [Fungsi Membuat Gruop otomatis]
► Remove all chat [Fungsi MengHapus seluruh riwayat chat]
► Gn: (name) [fungsi menganti nama gruop]
► Kick: (mid) [fungsi kick via mid]
► Invite: (mid) [fungsi undang member via mid]
► Welcome 
► Bc: (text) [Fungsi Kirim Pesan Broadcast ke semua group]
► Cancelall [fungsi Membatalkan undang yang ke pending]
► Gurl [fungsi membuka link qr]
► Self ;Like  [fungsi auto like ]
► Speed [fungsi Melihat kecepatan Bot]
► Ban [ Fungsi Banned  Kontak]
► Unban [fungsi membuka Banned via kontak]
► Copy @ [Fungsi MengCopy Profil teman]
► Backup me [fungsi Mengembalikan ke asli]
► Ban @ [Fungsi Banned via Tag]
► Unban @ [Fungsi Membuka Banned via tag]
► Banlist [Fungsi Melihat daftar Banned]
► Kill ban [Fungsi ngekick yang kena banned]
"""
