...
💥[Group cancelalll] Membatalkan undangan gorup
💥[Leave︎ on/off]on\n
💥[Add on/off]on\n
💥[Share on/off] on\n
💥[Message change:「text」]
...
💥[Bye] you left the group
💥[Kill ban] kick unser yang ada dalam daftar hitam
💥[Kill 「@」] 
💥[Ban 「@」] By Tag 
💥[Unban 「@」] By Tag 
💥[Ban︎] Share Contact
💥[Unban︎] done
💥[Banlist︎]
💥[Cek ban] cek daftar ban
💥[Kil mid] 
💥[Kil ︎invite:「mid」] invite by mid people
💥[Kil ︎rename:「name」]
💥[Kil ︎gift]
💥[Respo︎n] KIL PRO NABIL 
💥[set]show your auto setting
💥[Bot cancel] PRO1
💥[Tagall] on/100
💥[Creator:] creator by Mlbond
...
wait = {
    ...
    'timeline':False, 
    'autoAdd':False,
    'message':"Terima kasih add nya",
    "lang":"JP",
    "comment":"Terima kasih add nya",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
			...
			if wait["atjointicket"] == True:
                ...
                if wait["clock"] == True:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "People who readed %s\0 it\n\nPeople who have ignored reads\n%sIt is abnormal ♪\n\nReading point creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                ...
                if msg.toType == 2:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        ki.sendText(msg.to,"Not found Kil")
                        kk.sendText(msg.to,"Not found Pro")
                        kc.sendText(msg.to,"Not found Nabil")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Succes Kil")
                                ki.sendText(msg.to,"Succes Kil")
                                kk.sendText(msg.to,"Succes Pro")
                                kc.sendText(msg.to,"Succes Nabil")
                            except:
                                ki.sendText(msg.to,"Error")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Ok Kil 􀨁􀄻double thumbs up􏿿")
                kk.sendText(msg.to,"Ok Pro 􀨁􀄻double thumbs up􏿿")
                kc.sendText(msg.to,"Ok Nabil 􀨁􀄻double thumbs up􏿿")
#-----------------------------------------------
            elif "Bc " in msg.text:
...
#-----------------------------------------------
            ...
            elif msg.text in ["Kil say hinata pekok"]:
            ...
            elif msg.text in ["Nabil say didik pekok"]:
            ...
            elif msg.text in ["Kil say bobo ah","Bobo dulu ah"]:
                ki.sendText(msg.to,"Have a nice dream Kil 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Have a nice dream Pro 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Have a nice dream Nabil 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Cv say chomel pekok"]:
                ki.sendText(msg.to,"Chomel pekok 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Chomel pekok 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Chomel pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["#welcome"]:
                ki.sendText(msg.to,"Selamat datang di Kil Family Room")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Kil")
                kk.sendText(msg.to,"Pro")
                kc.sendText(msg.to,"Nabil")
#-----------------------------------------------
